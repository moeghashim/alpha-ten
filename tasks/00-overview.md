...
| 03 | `03-orchestrator-clients.md`        | `github.ts`, `cursor.ts`, `render.ts` clients  | ~300 |
| 04 | `04-orchestrator-flow.md`           | `orchestrator.ts` + `POST/GET /v1/apps` routes | ~250 |
| 05 | `05-web-form.md`                    | Next.js form + status page                     | ~250 |
| 06 | `06-deploy-smoke.md`                | Render Blueprint deploy + end-to-end smoke     | ~50 |

Total ~1300 LOC across six PRs.
